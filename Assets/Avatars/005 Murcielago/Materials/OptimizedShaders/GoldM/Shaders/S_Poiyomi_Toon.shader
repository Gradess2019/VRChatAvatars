Shader "Hidden/.poiyomi/• Poiyomi Toon •/GoldM-GoldM"
{
    Properties
    {
...
#define PROP_ATTENUATIONMULTIPLIER 0.1
...
#define PROP_RIMSHARPNESS 0.4
#define PROP_RIMSTRENGTH 0.2
...
#define PROP_MATCAPINTENSITY 0.6
